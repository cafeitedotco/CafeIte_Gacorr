...
class HomePageUserState extends State<HomePageUser> {
  ...
  String dropdownValue = 'Makanan Berat';
  ...
  Widget _buildMenuCard(MakananberatModel item) {
    return Card(
      elevation: 3,
  ...
  void _showMenuDetail(MakananberatModel item) {
    showDialog(
      context: context,
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CartPage(cartItems: cartProvider.items),
                        ),
                      );
                    },
                  ),
