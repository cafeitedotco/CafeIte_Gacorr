...
class _OrderTrackingPageState extends State<OrderTrackingPage> {
  ...
  // Add the cancel order functionality
    ...
    try {
      ...
      if (user != null) {
        ...
        if (orderQuery.docs.isNotEmpty) {
          ...
          final initialStatus = orderQuery.docs.first.data()['status_pesanan'];
          ...
          _orderSubscription = _firestore
            ...
            if (snapshot.exists) {
              ...
              print('Raw status from Firebase: $status');
  ...
  final List<String> statusOrder = [
    'Masuk', // Tambahkan status 'Masuk'
    'Menunggu Konfirmasi',
    'Makanan Sedang Dibuat',
    'Makanan Sedang Diantar',
    'Kurir Telah Sampai',
    'Orderan Selesai',
    'Dibatalkan' // Tambahkan status 'Dibatalkan'
  ];
  ...
  Widget build(BuildContext context) {
    print('Current status in build: $_currentStatus');
    bool canCancel = _currentStatus == 'Masuk';
                ...
                if (canCancel)
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: isCancelling ? null : _showCancelConfirmation,
