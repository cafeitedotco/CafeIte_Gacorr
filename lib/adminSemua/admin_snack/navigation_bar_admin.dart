...
import 'package:cafeite/adminSemua/admin_snack/pages/profile_admin.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'package:cafeite/utils/restapi.dart';
import 'package:cafeite/utils/model.dart';
import 'package:cafeite/adminSemua/admin_snack/pages/pesanan.dart';
import 'package:cafeite/adminSemua/admin_snack/pages/dashboard.dart';

class BottomNavigationAdminSnack extends StatelessWidget {
  const BottomNavigationAdminSnack({Key? key}) : super(key: key);
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => HomePageAdminSnack()),
                    (Route<dynamic> route) => false,
                  );
                },
              ),
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ProfileScreenAdminSnack()),
                    (Route<dynamic> route) => false,
                  );
                },
              ),
