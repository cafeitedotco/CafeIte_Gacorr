...
import 'package:cafeite/adminSemua/admin_makanan/pages/detail_pemesanan.dart';
  ...
  Future<void> _handleOrderAction(PesananModel order, String action) async {
    try {
      ...
      if (action == 'accept') {
        ...
        print('Rejecting order: ${order.order_id}'); // Debug print
        ...
        print('Firestore update successful for rejection'); // Debug print
        ...
        print('REST API update for rejection: $success'); // Debug print
