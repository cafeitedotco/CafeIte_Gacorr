...
class HomePageAdminMakanan extends StatefulWidget {
  const HomePageAdminMakanan({super.key});

  @override
  HomePageAdminMakananState createState() => HomePageAdminMakananState();
}

class HomePageAdminMakananState extends State<HomePageAdminMakanan> {
  final searchKeyword = TextEditingController();
  DataService ds = DataService();
  List<MakananModel> makananberat = [];

  String loggedInUserEmail =
      "tenant1@gmail.com"; // Ubah sesuai email pengguna yang login
