...
import 'package:cafeite/adminSemua/admin_minuman/pages/profile_admin.dart';
import 'package:cafeite/adminSemua/admin_minuman/pages/pesanan.dart';
...
class BottomNavigationAdminMinuman extends StatelessWidget {
  const BottomNavigationAdminMinuman({Key? key}) : super(key: key);
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => HomePageAdminMinuman()),
                    (Route<dynamic> route) => false,
                  );
                },
              ),
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ProfileScreenAdminMinuman()),
                    (Route<dynamic> route) => false,
                  );
                },
              ),
