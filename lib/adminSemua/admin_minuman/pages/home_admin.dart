...
import 'package:cafeite/adminSemua/admin_minuman/navigation_bar_admin.dart';

class HomePageAdminMinuman extends StatefulWidget {
  const HomePageAdminMinuman({super.key});

  @override
  HomePageAdminMinumanState createState() => HomePageAdminMinumanState();
}

class HomePageAdminMinumanState extends State<HomePageAdminMinuman> {
  final searchKeyword = TextEditingController();
  DataService ds = DataService();
  List<MakananModel> makananberat = [];

  String loggedInUserEmail = "tenant2@gmail.com";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const BottomNavigationAdminMinuman(),
    );
  }
